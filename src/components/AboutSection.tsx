      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <motion.div
            ...
            transition={{ duration: 0.8 }}
          >
            <p className="font-body text-sm tracking-[0.3em] uppercase text-accent mb-3">Our Story</p>
            <h2 className="font-display text-3xl md:text-4xl lg:text-5xl font-bold text-foreground leading-tight">
              Born in Amravati,
              <br />
              <span className="italic text-primary">Brewed with Love</span>
            </h2>
            <p className="font-body text-base md:text-lg text-muted-foreground mt-6 leading-relaxed">
...
function LeafIcon({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M11 20A7 7 0 019.8 6.9C15.5 4.9 20 4 20 4s0 4.5-2 10.2A7 7 0 0111 20z" />
      <path d="M5.7 18.3L20 4" />
    </svg>
  );
}
